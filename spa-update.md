...
- [**Langkah 4: Instalasi Dependensi**](#langkah-4-instalasi-dependensi)
  ...
  - [**6. Tambahkan Skrip Build dengan `esbuild.config.js`**](#6-tambahkan-skrip-build-dengan-esbuildconfigjs)
- [**Langkah 5: Implementasi Tailwind CSS**](#langkah-5-implementasi-tailwind-css)
- [**Langkah 6: Implementasi Halaman Home, About, Help**](#langkah-6-implementasi-halaman-home-about-help)
...
- [**Langkah 7: Mekanisme Routing**](#langkah-7-mekanisme-routing)
- [**Langkah 8: Entry Point dan Index**](#langkah-8-entry-point-dan-index)
...
- [**Langkah 9: Deployment Keberbagai Hosting**](#langkah-9-deployment-keberbagai-hosting)
  ...
  - [**Tips**](#tips)
- [**Langkah 10: Deploy aplikasi ke ESP32-C3**](#langkah-10-deploy-aplikasi-ke-esp32-c3)
...
1. **Style:** **Tailwind CSS** untuk styling cepat dan konsisten.
1. **Programming:** **TypeScript** untuk pengkodean yang lebih terstruktur dan tipe aman.
1. **Building Tool:** **esbuild** untuk proses bundling cepat dan ringan.
1. **Metodologi:** Component-Driven Development (CDD) atau Object-Oriented Programming (OOP) untuk modularitas.
1. **Hosting:** Di **ESP32-C3** untuk penggunaan di perangkat IoT, dengan opsi deploy ke **GitHub Pages**.
1. **Struktur File:** Semua konfigurasi diletakkan di root direktori untuk kesederhanaan pengelolaan.
1. **Navigasi:** Routing manual tanpa library tambahan untuk menghemat ruang penyimpanan di ESP32.
...
Edit file `tailwind.config.js` untuk menambahkan path file yang akan dipindai oleh Tailwind CSS:

```javascript
module.exports = {
  content: ['./src/**/*.html', './src/**/*.ts'], // Path file HTML dan TypeScript
  theme: {
    extend: {}, // Memungkinkan Anda untuk menambahkan tema atau gaya tambahan
  },
  plugins: [], // Plugin tambahan untuk Tailwind (opsional)
};
```

**Penjelasan:**

- **`content`:** Tailwind hanya akan memproses kelas CSS yang digunakan dalam file HTML atau TypeScript di path ini, sehingga menghasilkan file CSS yang lebih kecil.
- **`theme.extend`:** Digunakan untuk memperluas atau menambahkan tema baru, seperti warna, ukuran font, atau elemen lainnya.
...
#### **6. Tambahkan Skrip Build dengan `esbuild.config.js`**

Tambahkan skrip berikut di dalam `package.json` untuk menjalankan konfigurasi dari file `esbuild.config.js`:
...
### **Langkah 6: Implementasi Halaman Home, About, Help**
...
### **Langkah 8: Entry Point dan Index**
...
### **Langkah 9: Deployment Keberbagai Hosting**
...
### **Langkah 10: Deploy aplikasi ke ESP32-C3**
